...
8.1.0.  You’ll also need a recent C/C++ compiler (GCC or Clang on GNU/Linux and
...
Currently, the supported versions are Emacs 30 and Emacs 31.  Once Emacs 32 is
released, support for Emacs 30 will be dropped.
...
bazel_dep(name = "rules_elisp", version = "0.0.2")
#+END_SRC
...
toolchains of type ~@rules_elisp//elisp:toolchain_type~; see
