...
http_archive(
    name = "rules_python",
    # Backport pull request https://github.com/bazelbuild/rules_python/pull/572.
...
go_repository(
    ...
    sum = "h1:E8+3WU97Lt5Xo0dNFO/cWAueth1OS31bNSwxtuYJdmA=",
    version = "v0.0.0-20211117200010-5d4d2ecbe745",
)
